...
try:
    ...
    # Create reverse mappings for easy lookups
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "Humidity": 65,
                "Moisture": 54,
                "Soil_Type_ID": 2,  # Loamy
                "Crop_Type_ID": 10, # Wheat
                "Nitrogen": 38,
                "Potassium": 0,
                "Phosphorous": 0
            }
...
def get_categories():
    """
    Provides lists of available Soil Types and Crop Types for frontend dropdowns.
    """
    return {
...
def recommend_fertilizer(data: FertilizerInput):
    """
    Receives soil and crop data and returns a fertilizer recommendation.
    """
    try:
        # Step A: Create a DataFrame with the correct structure
        input_df = pd.DataFrame(0, index=[0], columns=model_columns)

        # Step B: Populate the numerical features
        ...
        # Step C: Handle one-hot encoded features using IDs
